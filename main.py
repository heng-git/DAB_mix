...
from models.DAB_DETR.backbone import FrozenBatchNorm2d
...
def get_args_parser():
    ...
    parser.add_argument('--num_patterns', default=3, type=int,
    ...
    # Traing utils
    parser.add_argument('--output_dir', default='D://COCODIR//output_dir', help='path where to save, empty for no saving')
    ...
    parser.add_argument('--find_unused_params', action='store_false')
